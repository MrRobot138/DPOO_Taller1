...
public class ConsolaOlimpicos
{
	...
	private void ejecutarConsultaPais()
	{
		System.out.println("\n" + "Pais de un Atleta" + "\n");
		...
		if  (atleta == null)
		{
			...
			String nombrePais = calculadora.darNombrePais(atleta);
			System.out.println("El pais del atleta " + nombreAtleta + " es " + nombrePais );
